...
void test_validate_my_username()
{
     ...
     */
    const char * userNamePtr = my_username();
    char * allocatedUserName = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(allocatedUserName, userNamePtr, "Osama msg :) ");
}
